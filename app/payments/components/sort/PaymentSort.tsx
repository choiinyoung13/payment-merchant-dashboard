  ...
  return (
    <div className="mb-5 space-y-3">
      <div className="flex w-full items-center justify-between gap-2">
        <div className=" flex w-inherit justify-between items-center gap-2 flex-wrap sm:justify-start">
          <MonthDatePicker />
          <button
            type="button"
            onClick={() => setIsModalOpen(true)}
            className="flex items-center justify-center gap-1.5 min-[390px]:gap-2 lg:gap-3 rounded-lg px-1.5 min-[390px]:px-2 lg:px-3.5 py-1.5 min-[390px]:py-2 text-base text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-all cursor-pointer sm:hidden"
          >
            <svg
        ...
        <button
          type="button"
          onClick={() => setIsModalOpen(true)}
          className="hidden sm:flex items-center justify-center gap-1.5 min-[390px]:gap-2 lg:gap-3 rounded-lg px-1.5 min-[390px]:px-2 lg:px-3.5 py-1.5 min-[390px]:py-2 text-base text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-all cursor-pointer flex-shrink-0"
        >
          <svg
            className={`w-4 h-4 min-[390px]:w-5 min-[390px]:h-5 transition-colors ${
              hasActiveFilter ? 'text-[#425aeb]' : 'text-gray-400'
